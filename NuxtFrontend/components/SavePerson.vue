  ...
  <b-container>
    <div>
      <b-form @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <b-form-group id="input-group-2" label="First Name:" label-for="input-2" :class="{ 'form-group--error': $v.fname.$error }" >
            <b-form-input id="input-2" v-model.trim="$v.fname.$model"  placeholder="Enter first name"></b-form-input>
        ...
        <b-form-group id="input-group-3" label="Last Name:" label-for="input-3" :class="{ 'form-group--error': $v.lname.$error }" >
        ...
        <b-form-group id="input-group-4" label="Date Of Birth:" label-for="input-4"  :class="{ 'form-group--error': $v.date.$error }">
          <b-form-input
            id="input-4"
        ...
        <b-form-group id="input-group-5" label="Gender:"  :class="{ 'form-group--error': $v.gender.$error }" >
        ...
        <b-form-group id="input-group-6" label="Email:" label-for="input-6"  :class="{ 'form-group--error': $v.email.$error }">
          <b-form-input
            id="input-6"
        ...
        <b-form-group id="input-group-7" label="Password:" label-for="input-7" :class="{ 'form-group--error': $v.password.$error }">
          <b-form-input
            id="input-7"
          ...
          <div class="error" v-if="!$v.password.required"  >Field is required</div>
           <div class="error" v-if="!$v.password.minLength">Should be greater than {{$v.password.$params.minLength.min}} </div>
        </b-form-group>
